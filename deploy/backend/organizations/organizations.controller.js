...
let OrganizationsController = OrganizationsController_1 = class OrganizationsController {
    ...
    update(id, updateOrganizationDto, req) {
        return this.organizationsService.update(id, updateOrganizationDto, req.user.userType, req.user.organizationId);
    }
    remove(id, req) {
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)(user_entity_1.UserType.SUPERADMIN, user_entity_1.UserType.ORGADMIN, user_entity_1.UserType.ADMIN),
...
], OrganizationsController.prototype, "getOrgAdmin", null);

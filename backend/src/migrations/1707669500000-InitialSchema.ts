...
export class InitialSchema1707669500000 implements MigrationInterface {
    name = 'InitialSchema1707669500000'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Creare tabel organizations
        ...
        // Creare tabel verification_tokens
        await queryRunner.query(`
